...
function NumPlayersPage() {
  ...
  function handlePlayerCount(string) {
    ...
    else if (string == "<" && maxPlayers != 0) setMaxPlayers(maxPlayers - 1);
  ...
  return (
    <div className="player-container">
      ...
      <img
        ...
        src="../src/assets/bubble_btm_right.png"></img>
      ...
      <button className="cIncrease-btn" onClick={() => handleComCount(">")}>
        {">"}
      </button>
      <button className="cDecrease-btn" onClick={() => handleComCount("<")}>
        {"<"}
      </button>
